...
![image](https://raw.githubusercontent.com/felanbird/wiki-1/cleanup-images/img/XP-Globes-example.png)
...
![image](https://raw.githubusercontent.com/felanbird/wiki-1/cleanup-images/img/XP-Globes-tooltip.png)

### Progress colors
The XP globe colors can be fully customized with the 3 options given: arc color, outline color, background color

![image](https://raw.githubusercontent.com/felanbird/wiki-1/cleanup-images/img/XP-Globes-color-picker.png)

### Progress arc width
Changes the thickness of the arc in the XP globe  

![image](https://raw.githubusercontent.com/felanbird/wiki-1/cleanup-images/img/XP-Globes-arc-width.png)

### Size of orbs
Resizes the XP globes (lower value is smaller)  

![image](https://raw.githubusercontent.com/felanbird/wiki-1/cleanup-images/img/XP-Globes-size.png)
